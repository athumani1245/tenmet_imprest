...
class FleetXls(models.AbstractModel):
    _name = 'report.tenmet_imprest.report_fleet_xls'
    ...
    def generate_xlsx_report(self, workbook, data,lines):
        ...
        worksheet.merge_range(2, 1, 2, 2, "FLEET REPORT", bold_center)
        ...
        sr_no = 0
        row = 11
        grand_total = lines.fleet_total
         

           
        for line_rec in lines.fleet_lines_ids:
